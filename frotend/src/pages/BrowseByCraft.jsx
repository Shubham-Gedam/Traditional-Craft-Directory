...
const BrowseByCraft = () => {
  ...
  const [filters, setFilters] = useState({ craftCategory: craftId || "" });
  ...
  useEffect(() => {
    setFilters((f) => ({ ...f, craftCategory: craftId || "" }));
  }, [craftId]);
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <h1 className="text-2xl font-medium text-gray-900 mb-6">Browse by craft</h1>
